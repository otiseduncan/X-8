...
def list_capabilities() -> list[Capability]:
    return [
        ...
        Capability(name="local_system_body", status=CapabilityStatus.IMPLEMENTED, summary="Local system status reports OS, CPU, workspace roots, drive usage, and Docker reachability."),
        ...
        Capability(name="email_draft", status=CapabilityStatus.IMPLEMENTED, summary="Email drafting is available; external send remains disabled."),
        Capability(name="sms_draft", status=CapabilityStatus.IMPLEMENTED, summary="SMS drafting is available; external send remains disabled."),
        Capability(name="email_send", status=CapabilityStatus.DISABLED, summary="External email send is disabled."),
        Capability(name="sms_send", status=CapabilityStatus.DISABLED, summary="External SMS send is disabled."),
