...
import { receiptCards } from './cardHelpers';
...
export function App() {
  ...
  const githubHandlers = createGitHubApprovalHandlers({
    appendMessage,
    code,
    githubAuth,
    githubOps,
  ...
  const { approveApply, createGitHubCards, githubApprovalCard, previewGitHubOp, refreshGitHubOps, requestApply } = githubHandlers;
  ...
  const { attachFiles, proposeDiffCard, removeAttachment, submitConfigScan, submitMessage } = conversationHandlers;
