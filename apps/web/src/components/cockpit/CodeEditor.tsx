...
const artifactHighlighting = syntaxHighlighting(HighlightStyle.define([
  ...
  { tag: tags.tagName, color: '#22d3ee', fontWeight: '700' },
  ...
  { tag: tags.controlKeyword, color: '#c084fc', fontWeight: '700' },
  { tag: [tags.propertyName, tags.attributeValue], color: '#38bdf8' },
  { tag: [tags.className, tags.definition(tags.className)], color: '#f472b6' },
  { tag: [tags.variableName, tags.definition(tags.variableName)], color: '#e5f4ff' },
  { tag: [tags.function(tags.variableName), tags.function(tags.propertyName)], color: '#34d399' },
